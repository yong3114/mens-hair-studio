...
export const SLOT_START=0
export const SLOT_END=24
...
export function nextCalendarCursor(cursor,view,dir){const d=new Date(cursor);if(view==='month'||view==='agenda'||view==='map'){d.setDate(1);d.setMonth(d.getMonth()+dir)}else if(view==='week')d.setDate(d.getDate()+7*dir);else d.setDate(d.getDate()+dir);return d}
